      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            14 gün boyunca tüm özellikleri sınırsız test edin. Uzaktan kurulum desteği ve canlı onboarding görüşmesi dahil.
            Formu doldurun, 24 saat içinde randevunuzu oluşturalım.
          </p>
          <div className="mt-8 grid md:grid-cols-3 gap-4 text-left">
            {[
              '14 Gün Full Sürüm',
              'Uzaktan Kurulum & Eğitim',
              'WhatsApp Destek + Video Kılavuz'
            ].map((item) => (
              <motion.div
                key={item}
